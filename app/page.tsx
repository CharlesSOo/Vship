          ...
          <div className="space-y-6">
            <div className="p-6 bg-white/5 border border-white/10 rounded-lg">
              <h3 className="text-lg font-semibold mb-3">
                How do I install VShip?
              </h3>
              <div className="text-white/60 text-sm space-y-4">
                <div>
                  <p className="font-medium mb-2">1. Download and open VShip-0.9.0.dmg</p>
                  <p className="text-sm">Drag VShip.app to your Applications folder</p>
                </div>
                <div>
                  <p className="font-medium mb-2">2. If you get a security warning</p>
                  <p className="text-sm mb-2">VShip isn't code-signed yet. Use one of these methods:</p>
                  <div className="space-y-2 pl-4">
                    <div>
                      <p className="font-medium text-xs">Right-click method:</p>
                      <ol className="text-xs space-y-1 list-decimal list-inside ml-2">
                        <li>Right-click VShip.app in Applications</li>
                        <li>Select "Open" → Click "Open" in dialog</li>
                      </ol>
                    </div>
                    <div>
                      <p className="font-medium text-xs">Terminal command (if reinstalling):</p>
                      <code className="block text-xs bg-black/50 p-2 rounded border border-white/10 text-green-400 font-mono mt-1">
                        xattr -cr /Applications/VShip.app
                      </code>
                    </div>
                  </div>
                  <p className="text-xs text-white/40 mt-2">ℹ️ You only need to do this once</p>
                </div>
                <div>
                  <p className="font-medium mb-2">3. Enter your Vercel API token</p>
                  <p className="text-sm">Get it from <a href="https://vercel.com/account/tokens" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">vercel.com/account/tokens</a></p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-white/5 border border-white/10 rounded-lg">
              ...
              <p className="text-white/60 text-sm">
                VShip is currently unsigned because it requires a $99/year Apple Developer account. This is common for free indie Mac apps. Code signing and notarization are in the process of being applied.
              </p>
            </div>
